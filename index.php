...
// افزونه‌های فعال پیش از هر مسیریابی بارگذاری می‌شوند تا بتوانند به
// قلاب‌ها بچسبند. اینجا و نه در config.php: آن فایل متعلق به کاربر است
// و در به‌روزرسانی جایگزین نمی‌شود.
loadPlugins();
